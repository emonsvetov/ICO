...
Route::middleware(['auth:api', 'json.response', 'verified'])->group(function () {
    ...
    //Program Merchant relation
    Route::post('/v1/merchant/program', [App\Http\Controllers\API\MerchantProgramController::class, 'store'])->name('api.v1.merchant.program.create');
    Route::get('/v1/merchant/{merchant}/program', [App\Http\Controllers\API\MerchantProgramController::class, 'show'])->name('api.v1.merchant.program.show')->middleware('can:view,merchant');
    ;
    Route::put('/v1/merchant/{merchant}/program', [App\Http\Controllers\API\MerchantProgramController::class, 'update'])->name('api.v1.merchant.program.update')->middleware('can:update,merchant');
    ;
    Route::delete('/v1/merchant/{merchant}/program', [App\Http\Controllers\API\MerchantProgramController::class, 'destroy'])->name('api.v1.merchant.program.destroy')->middleware('can:delete,merchant');
    ;
});
