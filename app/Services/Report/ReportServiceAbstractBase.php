...
/***
    NOT TO BE USED!!
    Rather use App\Services\reports\ReportServiceAbstract!!
    Keeping it only to support legacy implementation
    Do not add or use new methods or properties to this file
*/

namespace App\Services\Report;
use App\Services\reports\ReportServiceAbstract;
class ReportServiceAbstractBase extends ReportServiceAbstract {
}
...
// use DB;
//This should not be used. Please us
