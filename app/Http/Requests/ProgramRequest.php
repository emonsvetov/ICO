...
class ProgramRequest extends FormRequest
{
    ...
    {
        return [
            'account_holder_id' => 'sometimes|integer',
            ...
            'discount_rebate_percentage' => 'nullable',
            'expiration_rebate_percentage' => 'nullable',
            'percent_total_spend_rebate' => 'nullable',
            ...
            'low_balance_email' => 'nullable',
            'program_extras' => 'nullable',
            'program_transaction_fee' => 'nullable',
            'enable_uploads_while_awarding' => 'nullable',
        ];
    }
