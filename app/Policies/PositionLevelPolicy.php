...
class PositionLevelPolicy
{
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function update(User $authUser, Organization $organization, Program $program,PositionLevel $levelNumber)
    {
        if(!$this->__preAuthCheck($authUser, $organization, $program, $levelNumber)) return false;
        if($authUser->isAdmin()) return true;
