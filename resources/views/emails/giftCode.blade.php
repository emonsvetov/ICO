...
border-left:solid 1px;
    ...
    <tbody><tr><td>
        ...
        </td></tr><tr><td align="center" style="background-color:#ffffff; border:none; text-align=" center="center">
            <a href="{{ $contactProgramHost0 }}" class="inf-track-23177"><img src="{{ $imagePath }}nk110-edc07421-56e4-4b9b-b09b-584844e6843b-v2.png" border="0"></a><br>
            <span style="font-size:10px;">Unable to see the
                              button?
                              Click  <span style="text-decoration:underline;"><a href="{{ $contactProgramHost0 }}" class="inf-track-23179">Here</a></span>.</span>
            ...
            program administrator or click <a href="https://incentco.zendesk.com/anonymous_requests/new" class="inf-track-23181">here</a> to submit a ticket.
        </td></tr></tbody>
</table>
</body>
</html>
