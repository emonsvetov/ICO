            ...
            <td height="312" style="font-size: 14px;">
                <div style="width:600px; height:312px; background-color: rgb(241,233,227); text-align: center;">
                    <img style="margin: 25px;max-height: 80px;" src="{{ url( '/storage/' . $template['small_logo'])}}"
                         border="0"><br>
                    <span
                        style="font-size:60px; font-weight: bold; color: #333333;line-height: .75em;letter-spacing: -3px;">YOU'RE A PARTICIPANT</span><br>
                    <span style=" font-weight: bold; color: #333333;">YOU"RE ADDED AS A PARTICIPATE<br>IN OUR REWARDS PROGRAM</span>
                ...
                <p width="600px" style="margin-left:20px;
                    ...
                    <br>
                    <br>
                    You're added as a participate in our rewards
                    program. Login now to redeem your
                    points.
                </p>
            </td>
        </tr>
