        ...
        <tr>
            <td height="312" style="font-size: 14px;">
                <div style="width:600px; height:312px; background-color: rgb(241,233,227); text-align: center;">
                    ...
                    <br>
                    <span
                        style="font-size:50px; font-weight: bold; color: #333333;line-height: .75em;letter-spacing: -3px;">Your file "{{ $file }}" has been processed!</span>
...
{{--                </p>--}}
                <p style="margin-left:20px; margin-right:20px;">
                    Program<span style="font-weight:bold;"> {{ $program->name }}</span>.
                </p>
            </td>
        </tr>
        <tr>
            <td align="center" style=" border:none;
                ...
                <a href="{{ $contactProgramHost0 }}" class="inf-track-23171"></a><br>
