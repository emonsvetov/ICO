    ...
    public function up()
    {
        Schema::create('goal_plans', function (Blueprint $table) {
           ...
           // $table->bigIncrements('id');
            ...
            $table->decimal('factor_before', 9,4); //only for sales goal plan type
            $table->decimal('factor_after', 9,4);  //only for sales goal plan type
            ...
            $table->date('expire_date'); //for specified expiration rule
            
            $table->integer('achieved_event_template_id');
            $table->integer('exceeded_event_template_id'); //only for sales goal plan type
